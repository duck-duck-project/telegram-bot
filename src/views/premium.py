...
class PremiumSubscriptionInfoView(View):
    text = textwrap.dedent('''
        ...
        - 💌 Анонимные сообщения в чате. Вы сможете отправлять анонимные сообщения через личку бота, которые будут пересылаться в <a href="https://studmanas.t.me">основной чат Манаса</a>
